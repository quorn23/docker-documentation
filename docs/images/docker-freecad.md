...
[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Ffreecad?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh/gateway/linuxserver-ci/docker/linuxserver%2Ffreecad)
...
| Parameter | Function |
| :----: | --- |
| `3000` | FreeCAD desktop gui. |
| `3001` | FreeCAD desktop gui HTTPS. |
